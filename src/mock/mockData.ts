...
export const mockTopics: Topic[] = [
  ...
  { id: 't5', title: 'Nuclear energy is the solution to the climate crisis', category: 'Energy' },
...
export const mockDebates: Debate[] = [
  {
    ...
    debater1: { id: '1', username: 'alex_debater', position: 'for' },
    debater2: { id: '2', username: 'sarah_debate', position: 'against' },
    status: 'live',
    currentRound: 2,
    totalRounds: 3,
  ...
  },
  {
    ...
    debater1: { id: '3', username: 'mike_pro', position: 'against' },
    debater2: { id: '1', username: 'alex_debater', position: 'for' },
    status: 'live',
    currentRound: 1,
    totalRounds: 3,
